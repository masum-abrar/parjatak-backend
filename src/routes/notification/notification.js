...
router.post("/v1/create-notification", createNotification);
// router.get("/v1/products-email/:id", verify, sendProductEmail);
router.get("/v1/notifications/:id", getNotifications);
router.get("/v1/activities/:id", getActivities);
...
router.delete("/v1/delete-notification/:id", deleteNotification);
...
// For Customer
router.get("/v1/customer/notifications/:id", getNotificationsForCustomer);
router.get("/v1/customer/activities/:id", getActivitiesForCustomer);
